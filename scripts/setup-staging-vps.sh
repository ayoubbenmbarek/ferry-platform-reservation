...
echo "     - staging.maritime-reservations.com -> $(curl -s ifconfig.me)"
echo "     - api-staging.maritime-reservations.com -> $(curl -s ifconfig.me)"
echo "     - chatbot-staging.maritime-reservations.com -> $(curl -s ifconfig.me)"
echo ""
